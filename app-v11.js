(() => {
  ...
  const app = {
    ...
    modalLocked: false, recoveryPending: false, recoveryHandled: false
  };
  ...
  async function initialize() {
    ...
    if ("serviceWorker" in navigator && location.protocol !== "file:") navigator.serviceWorker.register("./service-worker-v11.js").catch(error => console.warn("Service worker", error));
    syncFromLocal();
    if (cloudConfigured()) {
