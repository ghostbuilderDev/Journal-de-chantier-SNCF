const CACHE='journal-rapport-v15.10.5';
const ASSETS=['./index.html','./styles.css','./collaboration.css?v=15.10.5','./report-actions.js?v=15.10.5','./collaboration.js?v=15.10.5','./app.js?v=15.10.5','./journal-config.js','./journal-archive.js?v=15.10.4','./vendor/supabase.js','./vendor/pdf-lib.min.js','./data/price-catalog.js','./data/terrain-catalog.js','./data/billing-evidence.js','./icons/rapport-journalier-ainm.png','./icons/rapport-journalier-ainm-pwa.png','./assets/ainm-infrapole-paris-sud-est.jpg','../journal-composer.js?v=15.7.1'];
