...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v152-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260908000300_v15_2_cr_simple.sql',m.BACKEND)
