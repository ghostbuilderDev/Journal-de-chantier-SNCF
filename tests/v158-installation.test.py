...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v158-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_interrupted_v158_release_only_accepts_known_bytes(self):
  previous,new=b'paquet V15.8 interrompu',b'paquet corrige'
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260910000100_v15_8_preparation_briefing.sql',m.BACKEND)
