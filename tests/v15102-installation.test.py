...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v15102-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_interrupted_v15102_release_only_accepts_known_bytes(self):
 ...
 def test_phases(self):
  ...
  self.assertIn('.github/workflows/deploy-v15102.yml',m.BACKEND)
  self.assertIn('supabase/migrations/20260910000300_v15_10_rapports_mentions.sql',m.BACKEND)
