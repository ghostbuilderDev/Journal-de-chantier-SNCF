...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v151-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260908000200_v15_1_cr_perimetres.sql',m.BACKEND)
