...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v155-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_interrupted_v155_release_only_accepts_known_bytes(self):
  previous,new=b'paquet V15.5 interrompu',b'paquet corrige'
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260909000300_v15_5_requests_pdf.sql',m.BACKEND)
