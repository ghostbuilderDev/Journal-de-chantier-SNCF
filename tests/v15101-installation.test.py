...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v15101-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_interrupted_v15101_release_only_accepts_known_bytes(self):
