...
(async()=>{let browser,server;try{
 ...
 console.log('PASS V15.10.3 PWA: root/briefing/report workers and static assets install, private requests not cached, drafts retained, QR URL and correct offline page preserved.');
