...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v159-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_interrupted_v159_release_only_accepts_known_bytes(self):
  previous,new=b'paquet V15.9 interrompu',b'paquet corrige'
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260910000200_v15_9_completion_partagee.sql',m.BACKEND)
