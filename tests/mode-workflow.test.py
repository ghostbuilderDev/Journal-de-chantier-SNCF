...
spec = importlib.util.spec_from_file_location(
    'mode_workflow_under_test', SOURCE / 'scripts/wait-mode-workflow.py')
...
WORKFLOW_PATH = '.github/workflows/deploy-mode-chantier.yml'
...
class GitHub:
    ...
    def __call__(self, method, path, fields=None):
        ...
        if method == 'GET' and path == REPO_PATH + '/actions/workflows/deploy-mode-chantier.yml':
    ...
    def metadata_calls(self):
        return [call for call in self.calls if call[1].endswith('/actions/workflows/deploy-mode-chantier.yml')]
