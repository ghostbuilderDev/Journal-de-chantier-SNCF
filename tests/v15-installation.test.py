...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v15-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_phases(self):
  ...
  self.assertIn('app-v13.js',m.FRONTEND)
  self.assertIn('supabase/migrations/20260908000100_v15_cr_encadrement.sql',m.BACKEND)
