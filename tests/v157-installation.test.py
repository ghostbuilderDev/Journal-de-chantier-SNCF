...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v157-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_interrupted_v157_release_only_accepts_known_bytes(self):
  previous,new=b'paquet V15.7 interrompu',b'paquet corrige'
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260909000500_v15_7_reference_catalogue.sql',m.BACKEND)
