...
spec=importlib.util.spec_from_file_location('installer',ROOT/'scripts/prepare-v154-update.py')
...
class Tests(unittest.TestCase):
 ...
 def test_phases(self):
  ...
  self.assertIn('supabase/migrations/20260909000200_v15_4_production_email.sql',m.BACKEND)
