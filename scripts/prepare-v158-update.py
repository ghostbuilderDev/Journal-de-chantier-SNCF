#!/usr/bin/env python3
"""Bounded V15.7.1 -> V15.8 installation, repeatable backend-first phases."""
import hashlib,json,subprocess,sys
from pathlib import Path
sys.dont_write_bytecode=True
ROOT=Path(__file__).resolve().parents[1]
BACKEND=['.github/workflows/deploy-v158.yml', 'supabase/migrations/20260910000100_v15_8_preparation_briefing.sql', 'supabase/tests/cr-v158-backend.cjs', 'supabase/tests/cr-v158-postgres.sql', 'supabase/tests/cr-v158-deployment.cjs', 'scripts/deploy-v158-release.py', 'scripts/prepare-v158-update.py', 'scripts/wait-v158-workflow.py', 'scripts/update-v158-termux.sh', 'scripts/v158-base-sha256.json', 'tests/v158-installation.test.py', 'tests/v158-deployment.test.py']
FRONTEND=['app-v13.js', 'index.html', 'service-worker-v13.js', 'cr-off.js', 'cr-fields.js', 'journal-pdf.js', 'briefing-integration.js', 'briefing/index.html', 'briefing/journal-bridge.js', 'briefing/service-worker.js', 'briefing/briefing-preparation.js', 'briefing/briefing-attendance.js', 'briefing/briefing-v158.css', 'briefing/signer.html', 'briefing/signer.js', 'briefing/vendor/qrcodegen.js', 'tests/preparation-v158-browser.cjs', 'VERSION_V15.8.md', 'VERIFICATIONS_V15.8.txt']
MESSAGES={'backend':'Journal Chantier V15.8 - preparation des CR et signatures QR','frontend':'Journal Chantier V15.8 - ARF reel, reprise des nuits et briefing QR'}
...
def prepare(repo):
    manifest=json.loads((ROOT/'scripts/v158-base-sha256.json').read_text());changes={}
