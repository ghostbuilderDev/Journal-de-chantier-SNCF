#!/usr/bin/env python3
"""Bounded V15.2 -> V15.2 installation, repeatable backend-first phases."""
import hashlib,json,subprocess,sys
from pathlib import Path
sys.dont_write_bytecode=True
ROOT=Path(__file__).resolve().parents[1]
BACKEND=['.github/workflows/deploy-v152.yml', 'supabase/migrations/20260908000300_v15_2_cr_simple.sql', 'supabase/tests/cr-v152-backend.cjs', 'supabase/tests/cr-v152-retrofit.cjs', 'supabase/tests/cr-v152-postgres.sql', 'supabase/tests/cr-v152-email.test.cjs', 'supabase/functions/journal-cr-send-v152/index.ts', 'supabase/functions/journal-cr-send-v152/handler.mjs', 'supabase/functions/journal-cr-send-v152/markup.mjs', 'scripts/deploy-v152-release.py', 'scripts/prepare-v152-update.py', 'scripts/wait-v152-workflow.py', 'scripts/update-v152-termux.sh', 'scripts/v152-base-sha256.json', 'tests/v152-installation.test.py']
FRONTEND=['cr-off.js', 'cr-off.css', 'cr-ai.js', 'index.html', 'service-worker-v13.js', 'tests/cr-v152-browser.cjs', 'VERSION_V15.2.md', 'VERIFICATIONS_V15.2.txt']
MESSAGES={'backend': 'Journal Chantier V15.2 - demandes individuelles et rappels', 'frontend': 'Journal Chantier V15.2 - CR off simplifie et Gemini'}
...
def prepare(repo):
    manifest=json.loads((ROOT/'scripts/v152-base-sha256.json').read_text());changes={}
