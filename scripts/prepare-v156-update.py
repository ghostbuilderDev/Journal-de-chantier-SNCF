#!/usr/bin/env python3
"""Bounded V15.4 -> V15.6 installation, repeatable backend-first phases."""
import hashlib,json,subprocess,sys
from pathlib import Path
sys.dont_write_bytecode=True
ROOT=Path(__file__).resolve().parents[1]
BACKEND=['.github/workflows/deploy-v156.yml', 'supabase/migrations/20260909000400_v15_6_writing_references_delete.sql', 'supabase/functions/journal-writing-ai/index.ts', 'supabase/functions/journal-writing-ai/handler.mjs', 'supabase/tests/cr-v156-backend.cjs', 'supabase/tests/cr-v156-postgres.sql', 'supabase/tests/cr-v156-deployment.cjs', 'tests/writing-ai-v156.cjs', 'scripts/deploy-v156-release.py', 'scripts/deploy-v156-ai.py', 'scripts/prepare-v156-update.py', 'scripts/wait-v156-workflow.py', 'scripts/update-v156-termux.sh', 'scripts/configure-v156-gemini-termux.sh', 'scripts/v156-base-sha256.json', 'tests/v156-installation.test.py', 'tests/v156-deployment.test.py', 'data/cr-references-v156.json', 'scripts/extract-v156-references.py']
FRONTEND=['app-v13.js', 'cr-off.js', 'cr-ai.js', 'index.html', 'service-worker-v13.js', 'journal-composer.js', 'journal-emoji.js', 'journal-v156.css', 'data/emojis.json', 'data/UNICODE-LICENSE.txt', 'tests/cr-v156-browser.cjs', 'VERSION_V15.6.md', 'VERIFICATIONS_V15.6.txt', 'docs/REFERENCES_V15.6.md']
MESSAGES={'backend':'Journal Chantier V15.6 - references et suppressions definitives','frontend':'Journal Chantier V15.6 - redaction agrandie et CR simplifies'}
...
def prepare(repo):
    manifest=json.loads((ROOT/'scripts/v156-base-sha256.json').read_text());changes={}
