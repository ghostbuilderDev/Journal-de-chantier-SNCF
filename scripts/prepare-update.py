...
BACKEND = [
    ...
    'supabase/migrations/20260906000300_v14_2_contraintes_reelles.sql',
    'supabase/release-migrations.txt',
    'supabase/tests/backend-fixture.sql',
    'supabase/tests/backend-production-shape.sql',
    'supabase/tests/backend-production-assertions.sql',
