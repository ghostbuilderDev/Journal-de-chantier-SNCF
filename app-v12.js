(() => {
  ...
  function toggleDictation() {
    ...
    recognition.onerror = event => { if (event.error !== "aborted") toast(`Dictée interrompue : ${event.error}.`, "warning"); };
  ...
  async function openAdminDashboardDialog() {
    ...
    openModal({
      ...
      footer: `<button class="secondary-button" id="dashboardPendingBtn">Demandes en attente</button><button class="primary-button" id="closeAdminDashboard">Fermer</button>`,
      wide: true
    });
  ...
  function wireEvents() {
    ...
    $("emojiBtn").addEventListener("click", () => app.mode === "cloud-guest" ? openProfileDialog() : openEmojiPicker());
    $("mentionBtn").addEventListener("click", () => app.mode === "cloud-guest" ? openProfileDialog() : openMentionPicker());
    $("dictationBtn").addEventListener("click", () => app.mode === "cloud-guest" ? openProfileDialog() : toggleDictation());
    ...
    $("cameraBtn").addEventListener("click", () => app.mode === "cloud-guest" ? openProfileDialog() : els.cameraInput.click());
  ...
  async function initialize() {
    ...
    if ("serviceWorker" in navigator && location.protocol !== "file:") navigator.serviceWorker.register("./service-worker-v12.js?v=12").catch(error => console.warn("Service worker", error));
    syncFromLocal();
    if (cloudConfigured()) {
